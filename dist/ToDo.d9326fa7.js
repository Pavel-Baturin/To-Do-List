...
},{"@firebase/app":"../node_modules/@firebase/app/dist/esm/index.esm2017.js"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{"@firebase/database":"../node_modules/@firebase/database/dist/index.esm2017.js"}],"js/const.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PATH = exports.FIREBASE_CONFIG = exports.DB_TO_DO_LIST = void 0;
const DB_TO_DO_LIST = "db-to-do-list";
exports.DB_TO_DO_LIST = DB_TO_DO_LIST;
const FIREBASE_CONFIG = {
  apiKey: "AIzaSyA75S0DJiARX3pgtH-3wSVZYD4RsY0liZI",
  authDomain: "to-do-list-685c4.firebaseapp.com",
  databaseURL: "https://to-do-list-685c4-default-rtdb.europe-west1.firebasedatabase.app",
  projectId: "to-do-list-685c4",
  storageBucket: "to-do-list-685c4.appspot.com",
  messagingSenderId: "30257753670",
  appId: "1:30257753670:web:d151b4b13c6d90d68d6447"
};
exports.FIREBASE_CONFIG = FIREBASE_CONFIG;
const PATH = 'listItems/';
exports.PATH = PATH;
...
const app = (0, _app.initializeApp)(_const.FIREBASE_CONFIG);
const db = (0, _database.getDatabase)();

_refs.listRef.addEventListener('click', onListClick);

_refs.buttonRef.addEventListener('click', handlerClick);

function handlerClick() {
  const value = _refs.inputRef.value.trim();
...
async function createMarkup() {
  try {
    ...
    const murkup = arrayData.map(({
      id,
      value,
      approved
    }) => {
      const check = approved ? 'checked' : "";
      return `<li class="${check}"data-id="${id}">${value}<button class="close">X</button><li>`;
    });
    _refs.listRef.innerHTML = murkup.join('');
  } catch (error) {
    {
...
function saveData(value) {
  ...
  (0, _database.set)((0, _database.ref)(db, 'listItems/' + time), data);
}

function getData() {
  return new Promise((resolve, reject) => {
    (0, _database.onValue)((0, _database.ref)(db, _const.PATH), snapshot => {
...
async function onListClick(event) {
  ...
  (0, _database.update)((0, _database.ref)(db, _const.PATH + item.id), item);
  createMarkup();
}
...
function deleteItem(item) {
  (0, _database.remove)((0, _database.ref)(db, _const.PATH + item.id));
}
},{"firebase/app":"../node_modules/firebase/app/dist/index.esm.js","firebase/database":"../node_modules/firebase/database/dist/index.esm.js","./const.js":"js/const.js","./refs.js":"js/refs.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/ToDo.d9326fa7.js.map